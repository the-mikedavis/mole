...
# MoleWeb.Endpoint.init/2 when load_from_system_env is
...
config :mole, MoleWeb.Endpoint,
  ...
  url: [host: "mcarsondavis.com", port: {:system, "MOLE_PORT"}],
  http: [port: {:system, "MOLE_PORT"}],
...
# start per endpoint:
#
#     config :mole, MoleWeb.Endpoint, server: true
#
