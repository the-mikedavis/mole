defmodule MoleWeb.SurveyControllerTest do
  ...
  describe "create survey" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post(conn, Routes.survey_path(conn, :create), survey: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.survey_path(conn, :create), survey: @invalid_attrs)
  ...
  describe "update survey" do
    ...
    test "redirects when data is valid", %{conn: conn, survey: survey} do
      conn =
        put(
          conn,
          Routes.survey_path(conn, :update, survey),
          survey: @update_attrs
        )
